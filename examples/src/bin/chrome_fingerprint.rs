//! Пример использования Chrome fingerprint с rustls.
//!
//! Этот пример демонстрирует, как эмулировать TLS-отпечаток Chrome
//! при подключении к HTTPS-сайтам.
//!
//! Запуск:
//! ```bash
//! cargo run --bin chrome_fingerprint -- <hostname>
//! ```
...
use rustls::{ChromeFingerprint, ClientConfig, RootCertStore};
